...
public class ClienteMulticast {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try(MulticastSocket socket = new MulticastSocket(porta)) {
            ...
            // Em Wi-Fi corporativa/VPN o multicast costuma ser bloqueado. Para testar servidor e cliente na MESMA máquina, use a interface de loopback explicitamente:
